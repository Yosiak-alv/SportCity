...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-green-600 text-left text-base font-medium text-green-300 bg-green-900/50 focus:outline-none focus:text-green-200 focus:bg-green-900 focus:border-green-300 transition duration-150 ease-in-out'
