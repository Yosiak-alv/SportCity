...
<template>
    <Head title="Coach Session"/>
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Coach Training Session</h2>
        </template>

        <div class="py-12">
            <Card class="max-w-7xl spacing-y-6">
                <div class="grid grid-cols-2 gap-2 p-5 items-center" >
                    <div>
                        <div class="ml-12">
                    ...
                    <div class="ml-12 mt-2 text-lg">
                        <span class="inline text-5xl h-fit">{{ props.coach_training_session.name }}</span>
                        <br>
                        <span class="font-semibold">Description:</span> {{ props.coach_training_session.description }}
                        <br>
                        <span class="font-semibold">Duration:</span> {{ props.coach_training_session.duration }}
                        <br>
                        <span class="font-semibold">Starts At:</span> {{ props.coach_training_session.starts_at }}
                        <br>
                        <span class="font-semibold">Ends At:</span> {{ props.coach_training_session.finish_at }}
                        <br>
                    </div>
                </div>
            </Card>
                    ...
                    <Card>
                        <div class="p-6">
                            <div class="ml-8">
                                ...
                                <div class="overflow-y-scroll" style="height: 30rem;" v-if="props.training_session_clients != 0">
                                    <div class="text-base p-4" v-for="training_session_client in props.training_session_clients">
                ...
                <div class="col-span-2">
                    <Card>
                        <div class="p-6">
                            ...
                            <div class="ml-8" v-if="props.training_session_coaches != 0 ">
                                <div class="overflow-y-scroll" style="height: 30rem;" >
                                    <div class="text-base p-4" v-for="training_session_coach in props.training_session_coaches">
                                        <div class="w-full text-justify ">
                                            <h3 class="inline text-3xl" :class="{'underline' : props.coach.id == training_session_coach.id}">
                    ...
                    <Card>
                        <div class="p-6">
                            <div class="ml-8">
                                ...
                                <div class="overflow-y-scroll" style="height: 30rem;" v-if="props.training_session_exercises != 0" >
