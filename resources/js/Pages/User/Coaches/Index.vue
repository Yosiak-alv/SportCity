                                ...
                                <tr v-for="coach in props.coaches.data" :key="coach.id" class="hover:bg-gray-500  bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                                        <div v-if="getPermission('show coach')">
                                            <Link class="flex items-center" :href="route('products.show',{id: coach.id})">
                                                {{coach.dui}}
                                    ...
                                    <td class="px-6 py-4">
                                        <div v-if="getPermission('show coach')">
                                            <Link  :href="route('coaches.show',{id: product.id})">
                                                {{coach.name}}
                                            </Link>
                                        </div>
                                        <div v-else>
                                    ...
                                    <td class="px-6 py-4">
                                        <div v-if="getPermission('show coach')">
                                            <Link :href="route('coaches.show',{id: product.id})" v-if="getPermission('show product')">
                                                {{coach.lastname}}
                                            </Link>
                                        </div>
                                        <div v-else>
