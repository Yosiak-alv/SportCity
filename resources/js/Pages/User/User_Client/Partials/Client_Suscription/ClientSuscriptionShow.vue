...
const CancelSuscription = () => {
    router.patch(route('clients.cancelSuscription',{client:props.client.id, id:props.suscription.id}), {
        preserveScroll: true,
            ...
            <Card class="max-w-7xl spacing-y-6">
                <header class="p-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        In this section you can see the suscription for a client...
                    </p>
                </header>
                    ...
                    <div class="mb-5 pb-5 flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="inline-flex gap-x-2">
                            ...
                            <a
                                ...
                                :href="route('clients.suscriptionInvoice',{client:props.client.id,id:props.suscription.id})"
                                v-if="!props.suscription.canceled && !props.client.deleted_at"
                            >
                            ...
                            <div v-if="!props.client.deleted_at && getPermission('cancel client suscription')">
