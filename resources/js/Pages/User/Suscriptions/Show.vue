                    ...
                    <div class="mb-5 pb-5 flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="inline-flex gap-x-2">
                            ...
                            <a
                                ...
                                v-if="!props.suscription.canceled && props.suscription.client != null"
                            >
                    ...
                    <div class="grid md:grid-cols-2 gap-3">
                        ...
                        <div class="grid space-y-3">
                            <dl class="grid sm:flex gap-x-3 text-sm">
                                ...
                                <dd class="font-medium text-gray-800 dark:text-gray-200" :class="{'text-red-600 dark:text-red-400' : suscription.client == null}">
                                    <span class="block font-semibold">{{props.suscription.client?.name ?? 'Client Deleted'}}, {{props.suscription.client?.lastname ?? ''}}</span>
