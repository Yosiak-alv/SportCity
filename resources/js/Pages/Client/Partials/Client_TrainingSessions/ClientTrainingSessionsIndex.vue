...
watch(search, debounce((value) => {
    router.get(route('client.dashboard'), {search:value}, { preserveState:true , replace:true ,preserveScroll:true});
},500));
                ...
                <div class="w-full p-2 ">
                    <div class="text-center">
                        <div class="inline text-3xl font-semibold ">
                            <Link as="button" :href="route('client.training_sessions.show',training_session.id)" class="hover:underline">
